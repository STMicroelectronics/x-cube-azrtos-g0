...
When a hid device is plugged to STM32G0C1E-EV board, a Message will be displayed on the uart HyperTerminal showing
...
### <b>Hardware and Software environment</b>
  ...
  - STM32G0C1E-EV board Set-up
    - Plug the USB HID device into the STM32G0C1E-EV board through 'USB micro Type C-Male
