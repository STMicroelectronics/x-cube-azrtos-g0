...
This application provides an example of Azure RTOS USBX stack usage on STM32G0C1E-EV board, it shows how to develop USB Device communication Class "CDC_ACM" based application.
...
When plugged to PC host, the STM32G0C1E-EV must be properly enumerated as an USB Serial device and an STlink Com port.
